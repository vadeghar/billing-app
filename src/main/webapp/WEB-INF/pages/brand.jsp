...
<form:form action="${pageContext.request.contextPath}/admin/brand/saveBrand" method="post" modelAttribute="brand"  id="myForm" >
						...
						<div class="col-sm-24 col-md-12 borderOnePx">
							...
							<div class="row margin-10">
								<div class="" style="text-align: center;">
									<button id="btnSubmit" type="submit" class="btn btn-primary add-row" onclick="saveBrand();">Save</button>
									<button id="btnSubmit" type="button" class="btn btn-primary add-row" onclick="listBrand();">Cancel</button>
									<%-- <a href="${pageContext.request.contextPath}/brandList" data-toggle="tab" class="btn btn-warning">Cancel</a> --%>
								</div>									
							</div>
						</div>
						<div class="col-sm-24 col-md-12 borderOnePx">
										...
										<tbody>
											<c:forEach var="brand" items="${brandList}">
									           <tr>
									               ...
									               <td>${brand.email}</td>
									               <td>
									               <button type="button" class="" onclick="editBrand('${brand.id}')">
											          <span class="glyphicon glyphicon-pencil"></span>
											        </button>
											        <button type="button" class="" onclick="deleteBrand('${brand.id}')">
