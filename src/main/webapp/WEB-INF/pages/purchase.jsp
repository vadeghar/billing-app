...
<form:form action="${pageContext.request.contextPath}/admin/purchase/savePurchase" method="post" modelAttribute="purchaseView"  id="myForm" >
...
function addPurchaseItem() {
	...
	document.getElementById("myForm").action = "${pageContext.request.contextPath}/admin/purchase/addPurchaseItem";
...
function editPurchase(selectedId) {
	...
	document.getElementById("myForm").action = "${pageContext.request.contextPath}/admin/purchase/purchase";
	document.getElementById("myForm").submit();
}

function editPurchaseItem(purchaseItemId) {
	document.getElementById("selectedPurchaseItemId").value = purchaseItemId;
	document.getElementById("myForm").action = "${pageContext.request.contextPath}/admin/purchase/loadPurhcaseItem";
	document.getElementById("myForm").submit();
}
...
function deletePurchaseItem(purchaseItemId) {
	...
	if(confirm("Are you sure?")) {
		document.getElementById("myForm").action = "${pageContext.request.contextPath}/admin/purchase/deletePurchaseItem";
		document.getElementById("myForm").submit();
	}
...
function savePurchase() {
	document.getElementById("selectedId").value = 0;
	document.getElementById("myForm").action = "${pageContext.request.contextPath}/admin/purchase/savePurchase";
	//document.getElementById("myForm").method = "get";
	document.getElementById("myForm").submit();
}
