...
DROP TABLE IF EXISTS `jewel_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `jewel_category` WRITE;
/*!40000 ALTER TABLE `jewel_category` DISABLE KEYS */;
INSERT INTO `jewel_category` VALUES (1,'Rings (Men)'),(2,'Rings (Women)'),(3,NULL),(4,NULL);
/*!40000 ALTER TABLE `jewel_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `jewel_purchase`
--

DROP TABLE IF EXISTS `jewel_purchase`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jewel_purchase` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jewel_purchase`
--

LOCK TABLES `jewel_purchase` WRITE;
/*!40000 ALTER TABLE `jewel_purchase` DISABLE KEYS */;
INSERT INTO `jewel_purchase` VALUES (1,'2018-09-11 00:00:00',1,0.00),(3,'2018-09-23 00:00:00',1,0.00),(4,'2018-09-23 00:00:00',2,0.00),(5,'2018-09-23 00:00:00',1,0.00),(6,'2018-09-23 00:00:00',2,0.00),(7,'2018-09-23 00:00:00',2,0.00),(8,'2018-08-29 00:00:00',2,0.00),(9,'2018-09-23 00:00:00',1,0.00),(10,'2018-09-23 00:00:00',1,0.00),(11,'2018-09-24 00:00:00',1,0.00),(12,'2018-09-24 00:00:00',2,0.00),(13,'2018-09-24 00:00:00',1,0.00),(14,'2018-09-23 00:00:00',1,0.00),(15,'2018-09-23 00:00:00',2,0.00);
/*!40000 ALTER TABLE `jewel_purchase` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `jewel_purchase_details`
--

DROP TABLE IF EXISTS `jewel_purchase_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jewel_purchase_details` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `avg_weight` decimal(19,3) DEFAULT NULL,
  `category_id` bigint(20) DEFAULT NULL,
  `entry_date` datetime DEFAULT NULL,
  `generated_item_code` varchar(255) DEFAULT NULL,
  `making_charge_per_pc` decimal(19,2) DEFAULT NULL,
  `modified_date` datetime DEFAULT NULL,
  `quality` int(11) DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `rate_cut_at` decimal(19,2) DEFAULT NULL,
  `rate_cut_date` datetime DEFAULT NULL,
  `tax_rate` decimal(19,2) DEFAULT NULL,
  `total_weight` decimal(19,3) DEFAULT NULL,
  `wastage_per_pc` decimal(19,2) DEFAULT NULL,
  `purchase_id` bigint(20) DEFAULT NULL,
  `purchase_total` decimal(19,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKi4y8yi9b9n83d786f8uxqe5de` (`purchase_id`),
  CONSTRAINT `FKi4y8yi9b9n83d786f8uxqe5de` FOREIGN KEY (`purchase_id`) REFERENCES `jewel_purchase` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jewel_purchase_details`
--

LOCK TABLES `jewel_purchase_details` WRITE;
/*!40000 ALTER TABLE `jewel_purchase_details` DISABLE KEYS */;
INSERT INTO `jewel_purchase_details` VALUES (1,3.590,1,'2018-09-23 01:45:49',NULL,25.00,NULL,98,6,3167.00,'2018-09-23 00:00:00',0.00,21.560,0.00,1,NULL),(2,6.000,1,'2018-09-23 14:05:50',NULL,52.00,NULL,98,2,3167.00,'2018-09-23 00:00:00',3.00,12.000,0.15,3,38468.36),(3,3.120,2,'2018-09-23 14:05:50',NULL,22.00,NULL,98,5,3167.00,'2018-09-23 00:00:00',3.00,15.620,0.12,3,50046.84),(4,0.830,1,'2018-09-23 15:03:46',NULL,NULL,NULL,NULL,6,NULL,NULL,NULL,5.000,NULL,4,0.00),(5,1.670,1,'2018-09-23 15:06:57',NULL,NULL,NULL,NULL,3,NULL,NULL,NULL,5.000,NULL,5,0.00),(6,1.330,1,'2018-09-23 15:15:43',NULL,NULL,NULL,NULL,12,NULL,NULL,NULL,16.000,NULL,6,0.00),(7,8.250,1,'2018-09-23 15:21:21',NULL,NULL,NULL,NULL,4,NULL,NULL,NULL,33.000,NULL,7,0.00),(8,10.090,1,'2018-09-23 15:55:26',NULL,NULL,NULL,NULL,33,NULL,NULL,NULL,333.000,NULL,8,0.00),(9,1.000,1,'2018-09-23 16:13:07',NULL,NULL,NULL,NULL,33,NULL,NULL,NULL,33.000,NULL,9,0.00),(10,1.330,1,'2018-09-23 16:15:12',NULL,NULL,NULL,NULL,33,NULL,NULL,NULL,44.000,NULL,10,0.00),(11,0.770,1,'2018-09-23 16:29:50',NULL,NULL,NULL,NULL,43,NULL,NULL,NULL,33.000,NULL,11,0.00),(12,0.790,1,'2018-09-23 16:34:46',NULL,NULL,NULL,NULL,43,NULL,NULL,NULL,34.000,NULL,12,0.00),(13,0.110,1,'2018-09-23 16:35:58',NULL,NULL,NULL,NULL,45,NULL,NULL,NULL,5.000,NULL,13,0.00),(14,1.210,1,'2018-09-23 19:06:02','SJ-1RINGS (MEN)',NULL,NULL,NULL,19,NULL,NULL,NULL,23.000,NULL,14,0.00),(15,2.500,2,'2018-09-23 19:08:26','SJ-2RINGS (WOMEN)',NULL,NULL,NULL,2,NULL,NULL,NULL,5.000,NULL,15,0.00);
/*!40000 ALTER TABLE `jewel_purchase_details` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `jewel_stock`
--

DROP TABLE IF EXISTS `jewel_stock`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jewel_stock` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `category_id` bigint(20) DEFAULT NULL,
  `item_code` varchar(50) NOT NULL,
  `total_weight` decimal(19,3) NOT NULL,
...
--
-- Dumping data for table `jewel_stock`
--

LOCK TABLES `jewel_stock` WRITE;
/*!40000 ALTER TABLE `jewel_stock` DISABLE KEYS */;
INSERT INTO `jewel_stock` VALUES (1,2,'SJ-2RINGS (WOMEN)',5.000,2,'2018-09-23 19:08:26',NULL);
/*!40000 ALTER TABLE `jewel_stock` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `supplier` VALUES (1,'Gandhi Nagar','Kavadiguda','25648759544','Gandhi Nagar','Hyderabad','HDFC0000811','HDFC Bank','TS','Hyderabad','XYZ Company','vade@gmail.com','8975483289','ASDF2548FG21F','9875642589','Rajesh V','040-5879654','TS','8597458962','500080'),(2,'Mumbai','','878985478956','','','ICIC059001','ICICI','','Mumbai','Xyz','vadeghar1@gmail.com','','878954785','9875648755','Test','','','','856987');
...
-- Dump completed on 2018-09-23 19:11:01
