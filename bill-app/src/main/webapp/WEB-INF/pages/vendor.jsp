...
<div role="tabpanel" class="account-search" id="">
	...
	<div class="account-search collection-status">
		<form:form action="${pageContext.request.contextPath}/saveVendor" method="post" modelAttribute="vendor" class="form-inline">
						...
						<div class="col-sm-24 col-md-14">
							...
							<div class="row margin-top-20">
								<div class="col-md-12">
									...
									<a href="${pageContext.request.contextPath}/vendorList" data-toggle="tab" class="btn btn-warning">Cancel</a>
								</div>									
							</div>
						</div>
					</div>
